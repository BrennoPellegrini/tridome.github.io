	...
	AFRAME.registerComponent('video-controls', {
	  ...
	  position_control_from_camera: function(){
	    ...
	    if(camera) {
	        ...
	        self.y_position = camera.position.y - 0.5;
	        self.x_position = 0;
	        self.z_position = -3;
	  ...
	  update: function (oldData) {
	    ...
	    this.bar.setAttribute("height", "0.2");
	    this.bar.setAttribute("width", "3.4");
	    this.bar.setAttribute("position", "-0.05 -0.66 -1.999");


	    this.play_image.setAttribute("height", "0.3");
	    this.play_image.setAttribute("width", "0.3");
	    this.play_image.setAttribute("position", "-2.13 -0.65 -1.999");
